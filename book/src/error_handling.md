...
element indices, and fallback messages. Parameter-aware tooling can use
the strongly typed failed-validator getter and
`ValidatorMetadata::validator_params()` to read runtime validator parameters.
